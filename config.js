...
module.exports = {
    ...
    SESSION_ID: process.env.SESSION_ID || "MEGALODON~MD~moohQSzb#x_2E0zSTXaqTgYnRN3XCEsKzgWNSNxIriulI0VJ0gzo",  // Your bot's session ID (keep it secure)
    ...
    OWNER_NUMBER: process.env.OWNER_NUMBER || "50938598801",  // Owner's WhatsApp number
    
    OWNER_NAME: process.env.OWNER_NAME || getConfig("OWNER_NAME") || "DybyTech",           // Owner's name
    
    DEV: process.env.DEV || "237682803592",                     // Developer's contact number
